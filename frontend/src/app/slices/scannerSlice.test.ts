...
describe('scannerSlice', () => {
      ...
      systems: [
        {
          ...
          label: 'System 1',
          talkgroups: [
            { id: 10, talkgroupId: 200, label: 'TG1', name: 'Talkgroup 1', tag: 'Law', group: 'Police', ledColor: '#00e676' },
            { id: 11, talkgroupId: 201, label: 'TG2', name: 'Talkgroup 2', tag: 'Fire', group: 'Fire', ledColor: '#ff0000' },
          ],
        },
      ],
      branding: 'TEST',
  ...
  describe('transcriptReceived', () => {
    ...
    it('does not fail if callId not found', () => {
      ...
      state = reducer(
        state,
        transcriptReceived({ callId: 999, text: 'nope' }),
      );
