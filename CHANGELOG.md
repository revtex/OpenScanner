...
- `golang.org/x/text` bumped 0.37.0 → 0.39.0 (GO-2026-5970), pulling `x/term` 0.43.0 → 0.44.0 and `x/tools` 0.44.0 → 0.47.0 with it. Go standard-library advisories are covered by the toolchain: the CI and Docker builds request Go `1.26`, which resolves to the current patch release.
