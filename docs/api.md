...
> **Implementation status:** Phases 1–8 and Phase 10 endpoints are implemented. All other endpoints listed below are planned for future phases and are marked accordingly.
...
_No additional planned endpoints at this time. Future phases focus on the Admin Dashboard frontend, Push Notifications, Webhooks delivery, and Transcription._
